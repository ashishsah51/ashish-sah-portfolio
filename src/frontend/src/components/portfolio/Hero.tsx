...
const contactItems = [
  ...
  },
  {
    ...
    ocid: "contact_bar.linkedin.link",
  },
  {
    icon: Github,
    text: "GitHub",
    href: `https://${personalInfo.github}`,
    ocid: "contact_bar.github.link",
  },
];
...
export function Hero() {
  ...
  return (
    <>
      ...
      <section
        id="hero"
        className="relative pt-24 pb-16 sm:pt-32 sm:pb-20 px-4 sm:px-6 overflow-hidden"
      >
        {/* Animated background */}
        ...
        <div className="max-w-3xl mx-auto relative z-10 flex flex-col items-center text-center gap-6">
          {/* Top badges */}
          <motion.div
          ...
          >
            ...
            <div
              className="relative w-48 h-48 sm:w-56 sm:h-56 rounded-full overflow-hidden z-10"
              style={{
                boxShadow:
                  "0 0 60px oklch(0.55 0.18 255 / 0.5), 0 0 120px oklch(0.55 0.18 255 / 0.18)",
              }}
            >
              <img
          ...
          >
            ...
            <p className="text-lg sm:text-xl font-semibold gradient-text mt-1">
              {personalInfo.title}
            </p>
          </motion.div>
          ...
          >
            ...
            <span style={{ color: "oklch(0.82 0.18 70)" }}>
              $200M+ portfolio delivered.
            </span>
          </motion.p>
      ...
      >
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-x-1 gap-y-1 px-4">
            ...
            return (
              ...
              >
                ...
                {i < contactItems.length - 1 && (
                  <span className="contact-bar-divider" aria-hidden>
                    ·
                  </span>
                )}
              </motion.span>
